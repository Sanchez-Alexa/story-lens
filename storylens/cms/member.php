...
$sql = "SELECT forename, surname, joined, picture FROM member WHERE mem_id = :id;"; // SQL
...
$sql = "SELECT a.art_id, a.title, a.summary, a.category_id, a.member_id,
        ...
        ORDER BY a.art_id DESC;";                      // SQL
$articles = pdo($pdo, $sql, [$id])->fetchAll();    // Member's articles

$sql = "SELECT cat_id, name FROM category WHERE navigation = 1;"; // SQL to get categories
